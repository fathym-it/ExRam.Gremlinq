...
namespace ExRam.Gremlinq.Core
{
        ...
        IPropertyGremlinQuery<TElement> where TMeta : class
    {
        ...
        IGremlinQuery<string> IGremlinQueryBase.Explain() => AddStepWithObjectTypes<string>(ExplainStep.Instance, QuerySemantics.None);
        ...
        IGremlinQuery<TElement> IGremlinQueryBase<TElement>.Inject(params TElement[] elements) => Inject(elements);

        IAsyncEnumerable<TElement> IGremlinQueryBase<TElement>.ToAsyncEnumerable() => Environment.Pipeline.Execute(this);

        IValueGremlinQuery<TElement> IValueGremlinQueryBase<TElement>.Inject(params TElement[] elements) => Inject(elements);
        ...
        IGremlinQuery<string> IGremlinQueryBase.Profile() => AddStepWithObjectTypes<string>(ProfileStep.Instance, QuerySemantics.None);
        ...
        IGremlinQuery<TElement> IElementGremlinQueryBase<TElement>.Lower() => this;

        IGremlinQuery<TElement> IValueGremlinQueryBase<TElement>.Lower() => this;
        ...
        IElementGremlinQuery<TElement> IVertexPropertyGremlinQueryBase<TElement, TPropertyValue>.Lower() => this;

        IElementGremlinQuery<TElement> IVertexPropertyGremlinQueryBase<TElement, TPropertyValue, TMeta>.Lower() => this;

        IGremlinQuery<TElement> IPropertyGremlinQueryBase<TElement>.Lower() => this;

        IGremlinQuery<object[]> IArrayGremlinQueryBase.Lower() => Cast<object[]>();

        IGremlinQuery<object> IElementGremlinQueryBase.Lower() => Cast<object>();

        IGremlinQuery<object> IValueGremlinQueryBase.Lower() => Cast<object>();
        ...
        IGremlinQuery<object> IPropertyGremlinQueryBase.Lower() => Cast<object>();
